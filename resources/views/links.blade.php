...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,600;0,900;1,400&display=swap"
        rel="stylesheet">
    <!-- Styles -->
                ...
                <div class="card w-100">
                    ...
                    <ul class="list-group list-group-flush border-0">
                        <li class="list-group-item border-0 text-center p-4">
                            ...
                            <p class="mb-0 text-white">Nosso time é especializado em prover soluções estratégicas e
                                criativas para melhorar o desempenho on-line de empresas no mundo todo. 🚀💪</p>
                        </li>
                    </ul>
                </div>

                <a href="#" class="btn btn-primary btn-lg w-100 mt-3">Quero fazer um orçamento pelo Whatsapp</a>
                <a href="{{ route('home') }}" class="btn btn-primary btn-lg w-100 m-1">Quero visitar o site da
                    Karvz</a>
                <a href="{{ route('blog') }}" class="btn btn-primary btn-lg w-100">Quero visitar o blog da Karvz</a>
                ...
                <div class="card w-100">
                    ...
                    <ul class="list-group list-group-flush border-0">
                        <li class="list-group-item border-0 text-center p-4">
                            ...
                            <p class="mb-0 text-white">Estamos oficialmente inaugurando a nossa agência, e por isso,
                                <b>estamos realizando ofertas únicas e exclusivas</b>. Entre em contato conosco e
                                encontre os melhores preços do mercado!
                            </p>
                        </li>
                    </ul>
                </div>
